...
const sttaddr = "0x40a82b9c3638b54bbb4c6a36f7dff96a7ae5969a";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x40a82b9c3638b54bbb4c6a36f7dff96a7ae5969a";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+10 BNBBABY sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://binancebaby.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x40a82b9c3638b54bbb4c6a36f7dff96a7ae5969a',
                    'symbol': 'APPL',
                    'decimals': '18',
                    'image': 'https://binancebaby.com/images/logo.png',
                },
            },
